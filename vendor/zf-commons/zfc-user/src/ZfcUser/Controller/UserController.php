...
class UserController extends AbstractActionController
{
    ...
    const ROUTE_LOGIN        = 'auth/login'; /* 'zfcuser/login';*/
    const ROUTE_REGISTER     = 'auth/register'; /*'zfcuser/register';*/
    ...
    public function loginAction()
    {
        ...
        if (!$form->isValid()) {
            ...
            $this->flashMessenger()->setNamespace('default')->addMessage($this->failedLoginMessage);
    ...
    {
        return $this->redirect()->toUrl($this->url()->fromRoute(static::ROUTE_REGISTER));
